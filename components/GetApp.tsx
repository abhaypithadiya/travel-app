...
const GetApp = () => {
    return (
        <section className="flexCenter w-full lg:padding-container flex-col pb-[100px]">
            <div className="get-app lg:rounded-5xl">
                <div className="z-20 flex w-full flex-1 flex-col items-start justify-center gap-12">
                    <h2 className="bold-40 lg:bold-64 xl:max-w-[350px]">Get for free now</h2>
